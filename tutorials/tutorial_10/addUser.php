        ...
        <div class="form-control">
            ...
            <form class="" action="addUser.php" method="post" enctype="mutlipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" placeholder="Format: 09-777799999" pattern="^[0-9]{2}-[0-9]{9}" name="phone" value="<?php echo $phone; ?>" require>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" minlength="4" value="<?php echo $password; ?>" require>
                </div>
